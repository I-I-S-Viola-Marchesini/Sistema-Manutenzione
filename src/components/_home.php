<div class="container pt-5">
    ...
    <div class="row">
        <h1 class="text-center">Sistema Manutenzione</h1>
    </div>
    <br><br>
    <div class="row">
        ...
        <div class="col-12 col-lg-5 bg-primary-subtle rounded-3 shadow p-3">
            <h5 class="text-dark text-center mt-2">
                Consulta le risorse disponibili per l'utilizzo del portale:
            </h5>
            <div class="d-flex justify-content-center align-items-center p-2">
                <a href="/#/manuale" class="btn btn-outline-dark m-2">Manuale Utente</a>
                <a href="/#/contatti" class="btn btn-outline-dark m-2">Contatti Amministrazione</a>
            </div>
        </div>
    </div>
</div>